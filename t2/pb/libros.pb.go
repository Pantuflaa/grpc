...
var file_libros_proto_rawDesc = []byte{
	...
	0x05, 0x72, 0x61, 0x7a, 0x6f, 0x6e, 0x32, 0x9a, 0x02, 0x0a, 0x06, 0x4c, 0x69, 0x62, 0x72, 0x6f,
	...
	,
...
var file_libros_proto_depIdxs = []int32{
	...
	0, // 1: pb.Libros.RecibirChunk:input_type -> pb.ChunkLibro
	1, // 2: pb.Libros.DescargarLibro:input_type -> pb.Mensaje
	1, // 3: pb.Libros.Propuesta:input_type -> pb.Mensaje
	1, // 4: pb.Libros.PedirLibro:input_type -> pb.Mensaje
	1, // 5: pb.Libros.Vivo:input_type -> pb.Mensaje
	1, // 6: pb.Libros.GuardarLibro:output_type -> pb.Mensaje
	1, // 7: pb.Libros.RecibirChunk:output_type -> pb.Mensaje
	0, // 8: pb.Libros.DescargarLibro:output_type -> pb.ChunkLibro
	2, // 9: pb.Libros.Propuesta:output_type -> pb.RespPropuesta
	1, // 10: pb.Libros.PedirLibro:output_type -> pb.Mensaje
	1, // 11: pb.Libros.Vivo:output_type -> pb.Mensaje
