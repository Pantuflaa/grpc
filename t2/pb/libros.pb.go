...
var file_libros_proto_rawDesc = []byte{
	...
	0x05, 0x72, 0x61, 0x7a, 0x6f, 0x6e, 0x32, 0xe9, 0x01, 0x0a, 0x06, 0x4c, 0x69, 0x62, 0x72, 0x6f,
...
var file_libros_proto_depIdxs = []int32{
	...
	1, // 4: pb.Libros.Vivo:input_type -> pb.Mensaje
	1, // 5: pb.Libros.GuardarLibro:output_type -> pb.Mensaje
	0, // 6: pb.Libros.DescargarLibro:output_type -> pb.ChunkLibro
	2, // 7: pb.Libros.Propuesta:output_type -> pb.RespPropuesta
	1, // 8: pb.Libros.PedirLibro:output_type -> pb.Mensaje
	1, // 9: pb.Libros.Vivo:output_type -> pb.Mensaje
